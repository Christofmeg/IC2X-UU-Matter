...
public class TransferHandlerReplicator implements IRecipeTransferHandler<ContainerMatter> {

    private final StackHelper stackHelper;
    private final IRecipeTransferHandlerHelper handlerHelper;
    private IRecipeTransferInfo<ContainerMatter> transferHelper;

    public TransferHandlerReplicator(IRecipeTransferHandlerHelper handlerHelper) {
